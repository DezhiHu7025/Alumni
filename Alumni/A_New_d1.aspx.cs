...
namespace Alumni
{
    public partial class A_New_d1 : System.Web.UI.Page
    {
        ...
        protected void GetTaskContent(int ida)
        {
            ...
            if (myViewDate.Tables[0].Rows.Count > 0)
            {
                ...
                PlaceHolderList.Controls.Add(new LiteralControl("<div class=\"content-block-title\"></div><div class=\"content-block\"> " + form_d + "</div>"));
