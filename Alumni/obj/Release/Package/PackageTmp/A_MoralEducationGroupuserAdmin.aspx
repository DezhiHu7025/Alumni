<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_MoralEducationGroupuserAdmin.aspx.cs" Inherits="Alumni.A_MoralEducationGroupuserAdmin" %>
    ...
    <div style="width:100%; font-family:微軟正黑體;">
        ...
        <ContentTemplate>
            ...
            <div style="height:100px; display:none">
                当前用户：<asp:Label ID="Label2" runat="server" Text="Label" ForeColor="#3366CC"></asp:Label>
            </div>
            ...
            <div style="text-align:right;">
                ...
                <legend style="font-size:13px; color:#cc5599;">搜索条件</legend>
                    ...
                    　　　单据类型：
                    <asp:DropDownList ID="ddlStatus1" runat="server" Font-Names="微軟正黑體" 
                            AutoPostBack="True" 
            ...
            <tr style="height:40px; background-color:#CC5599;width:100%;">
                <td colspan="19" style="text-align:center; ">
                    <span style="color:White; font-size:20px;">校友入校申请单据后台数据</span>
                </td>
            </tr>
                ...
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">教职员姓名</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">教职员部门</span></td>
                <td align="center" style="color:Black; width:5%;"><span style="color:White;">校友学号</span></td>
                <td align="center" style="color:Black; width:5%;"><span style="color:White;">校友姓名</span></td>
                <td align="center" style="color:Black; width:5%;"><span style="color:White;">校友离校班级</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">校友入校日期</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">校友电话</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">其他拜访师长姓名</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">其他需求或备注</span></td>
