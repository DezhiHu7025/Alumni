<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_New_d3.aspx.cs" Inherits="Alumni.A_New_d3" %>
                ...
                <div class="page course page-on-center" data-page="course">
                    ...
                    <div class="toolbar order">
                        <div class="toolbar-inner">
                            <a href="A_New.aspx" class="item-link">返回<br />
                            </a>
                            |
        <a href="A_info_c.aspx?id=<%=id%>" class="item-link ">立即填单<br />
        </a>
                        </div>
                    </div>
                </div>
