...
/***/ (function(module, exports, __webpack_require__) {
	...
	var course = __webpack_require__(30)
	var coach = __webpack_require__(27)
	var coachAdmin = __webpack_require__(28)
	var coachAdminOrder = __webpack_require__(29)
	var team = __webpack_require__(39)
	var store = __webpack_require__(38)
	var move = __webpack_require__(32)
	var order = __webpack_require__(37)
	var mymemberpay = __webpack_require__(34)
	var mymember = __webpack_require__(33)
	var myorder = __webpack_require__(35)
	var orderSuccess = __webpack_require__(36)
	...
	var main = {
	    initFramework7: function() {
	        ...
	        $(document).on('pageInit', function(e) {
	            ...
	            console.log(page)
	            if(page.name){
	                if (page.name.indexOf('smart-select-radio-') > -1) {
	                    $('.link').addClass('ajax')
	                    return false
	                }
	            }
	            ...
	            switch (page.name) {
	                ...
	                case 'course':
	                    course.init(page)
	                    break;
	                case 'coachAdminOrder':
	                    coachAdminOrder.init(page)
	                    break;
	                case 'coachAdmin':
	                    coachAdmin.init(page)
	                    break;
	                case 'order':
	                    order.init(page)
	                    break;
	                ...
	                case 'mymember':
	                    ...
	                    break;
	                case 'mymemberpay':
	                    mymemberpay.init(page)
	                    break
	                case 'ordersuccess':
	                    orderSuccess.init(page)
	                    break
	                case 'myorder':
	                    myorder.init(page)
	                    break;
	...
	window.server = 'http://movetiger.cn/'
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"popup tablet-fullscreen login-screen\">\r\n    <div class=\"page-content \">\r\n        <div class=\"login-screen-title\">教练中心</div>\r\n        <form>\r\n            <div class=\"list-block\">\r\n                <ul>\r\n                    <li class=\"item-content\">\r\n                        <div class=\"item-inner\">\r\n                            <div class=\"item-title label\">账号</div>\r\n                            <div class=\"item-input\">\r\n                                <input type=\"text\" name=\"username\" placeholder=\"账号\">\r\n                            </div>\r\n                        </div>\r\n                    </li>\r\n                    <li class=\"item-content\">\r\n                        <div class=\"item-inner\">\r\n                            <div class=\"item-title label\">密码</div>\r\n                            <div class=\"item-input\">\r\n                                <input type=\"password\" name=\"password\" placeholder=\"密码\">\r\n                            </div>\r\n                        </div>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n            <div class=\"list-block\">\r\n                <ul>\r\n                    <li>\r\n                        <p class=\"button-big button-fill color-yellow button login\">登陆</p>\r\n                    </li>\r\n                </ul>\r\n            </div>\r\n        </form>\r\n    </div>\r\n</div>\r\n";
...
/***/ (function(module, exports) {
	...
	module.exports = "\r\n        {{#each data}}\r\n        <li>\r\n            <a href=\"pages/coach-admin-order.html?id={{id}}\" class=\" ajax item-content\" data-id=\"{{id}}\">\r\n                <div class=\"item-media\">\r\n                  <img src='{{headimg}}' class=\"headimg\">\r\n                </div>\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title-row\">\r\n                        <div class=\"item-title\">{{name}}</div>\r\n                        <div class=\"item-after\">¥{{price}}</div>\r\n                    </div>\r\n                    <div class=\"item-text\">节数：{{nop}}</div>\r\n                    {{#if pwd}}<div class=\"item-text\">密码：{{pwd}}</div>{{/if}}\r\n                    <div class=\"item-text\">时间：{{datetime}}</div>\r\n                    <div class=\"item-text\">订单号：{{out_trade_no}}</div> \r\n                </div>\r\n            </a>\r\n        </li>\r\n        {{/each}}\r\n";

/***/ }),
/* 6 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"list-block media-list\">\r\n    <ul>\r\n        {{#each data}}\r\n        <li>\r\n            <a href=\"pages/coach-admin-order.html?id={{id}}\" class=\"item-link ajax item-content\" data-id=\"{{id}}\">\r\n                <!-- <div class=\"item-media\">\r\n                  <img src='{{images}}' class=\"headimg\">\r\n                </div> -->\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title-row\">\r\n                        <div class=\"item-title\">{{name}}</div>\r\n                        <div class=\"item-after\">{{price}}</div>\r\n                    </div>\r\n                    <div class=\"item-text\">课程：{{desc}}</div>\r\n                </div>\r\n            </a>\r\n        </li>\r\n        {{/each}}\r\n    </ul>\r\n</div>\r\n";

/***/ }),
/* 7 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"swiper-container swiper-init\" data-pagination=\".swiper-pagination\">\r\n    <div class=\"swiper-wrapper\">\r\n        {{#each data.images}}\r\n        <div class=\"swiper-slide\">\r\n            <img src=\"{{this}}\" width=\"100%\">\r\n        </div>\r\n        {{/each}}\r\n    </div>\r\n    <div class=\"swiper-pagination\"></div>\r\n</div>\r\n<!-- 基本信息 -->\r\n<div class=\"content-block-title\" style=\"margin-top: 0\">基本信息</div>\r\n<div class=\"list-block media-list\">\r\n    <ul>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-media\">\r\n                <span class=\"coachbg\" style=\"background-image: url({{data.headimg}});\"></span>\r\n                \r\n            </div>\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title-row\">\r\n                    <div class=\"item-title\">{{data.name}}</div>\r\n                </div>\r\n                <div class=\"item-text\">{{data.certificate}}</div>\r\n                <div class=\"item-subtitle\">\r\n                    {{#each data.tag}}\r\n                        <span class=\"tip\">{{this}}</span>\r\n                    {{/each}}\r\n                </div>\r\n            </div>\r\n        </li>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-text desc\">{{data.desc}}</div>\r\n            </div>\r\n        </li>\r\n    </ul>\r\n</div>\r\n";

/***/ }),
/* 8 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"page-content\">\r\n    <div class=\"swiper-container\">\r\n        <div class=\"swiper-wrapper\">\r\n            {{#each data.images}}\r\n                <div class=\"swiper-slide\">\r\n                    <img src=\"{{this}}\" width=\"100%\">\r\n                </div>\r\n            {{/each}}\r\n        </div>\r\n        <div class=\"swiper-pagination\"></div>\r\n    </div>\r\n    <!-- 基本信息 -->\r\n    <div class=\"content-block-title\" style=\"margin-top: 0\">基本信息</div>\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n            <li>\r\n                <a href=\"pages/coach.html?id={{data.coach}}\" class=\"item-link ajax item-content coach\" data-id=\"{{data.coach}}\">\r\n                    <div class=\"item-media\">\r\n                        <span class=\"coachbg\" style=\"background-image: url({{data.coachHeadimg}});\"></span>\r\n                    </div>\r\n                    <div class=\"item-inner\">\r\n                        <div class=\"item-title-row\">\r\n                            <div class=\"item-title\">{{data.coachName}}</div>\r\n                        </div>\r\n                        <div class=\"item-text\">{{data.coachCertificate}}</div>\r\n                        <div class=\"item-subtitle\">\r\n                        {{#each data.coachTag}}\r\n                            <span class=\"tip\">{{this}}</span>\r\n                            {{/each}}\r\n                        </div>\r\n                        \r\n                    </div>\r\n                </a>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">费用： ¥{{data.total}} (Move会员 ¥{{data.vip}})</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">时间： 与教练沟通确认</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">支持门店: {{data.address}}</div>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n    <!-- 课程简介 -->\r\n    <div class=\"content-block-title\">课程简介</div>\r\n    <div class=\"content-block \">\r\n        {{data.desc}}\r\n    </div>\r\n    <div class=\"content-block-title\">适合人群</div>\r\n    <div class=\"content-block\">\r\n        {{data.tip}}    \r\n    </div>\r\n    <div class=\"content-block-title\">课程属性</div>\r\n    <div class=\"content-block\">\r\n        {{#each data.note}}\r\n            <span class=\"tip\">{{this}}</span>\r\n        {{/each}}\r\n    </div>\r\n    <div class=\"content-block-title\">私教流程:</div>\r\n    <div class=\"content-block\">\r\n        <div class=\"timeline\">\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">1成功购买课程</div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    2与教练沟通确认上课时间\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    3现场签到上课\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div class=\"toolbar order\">\r\n    <div class=\"toolbar-inner\">\r\n        <a  href=\"pages/order.html?id={{data.id}}&type=course\" class=\"item-link ajax \" >\r\n            立即预约<br><span>开通会员更划算</span>\r\n        </a>\r\n    </div>\r\n</div>\r\n";

/***/ }),
/* 9 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"list-block media-list\">\r\n    <ul>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title-row\">\r\n                    <div class=\"item-title\">支付项目:</div>\r\n                    <div class=\"item-after\">MoveTiger魔虎运动会员卡</div>\r\n                </div>\r\n            </div>\r\n        </li>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title-row\">\r\n                    <div class=\"item-title\">月份:</div>\r\n                    <div class=\"item-after pay-after\">\r\n                        <div class=\"item-text \">\r\n                            <p class=\"price\">\r\n                                {{#each data}}\r\n                                <span class=\"{{#js_compare \"this.month=='1'\"}} active {{/js_compare}} month{{month}}\" data-count=\"{{count}}\" data-id=\"{{id}}\" data-start=\"{{start}}\" data-end=\"{{end}}\" data-discount=\"{{discount}}\">{{month}}</span> {{/each}}\r\n                            </p>\r\n                            <p class=\"date\">起始日期： {{data[0].start}} ~ {{data[0].end}}</p>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </li>\r\n    </ul>\r\n</div>\r\n<div class=\"list-block\">\r\n    <ul>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">金额:</div>\r\n                <div class=\"item-after count\">¥{{data[0].count}}</div>\r\n            </div>\r\n        </li>\r\n        <li class=\"item-content discount\" {{#js_compare \"!this.data[0].discount\"}}style=\"display:none\" {{/js_compare}}>\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">优惠价:</div>\r\n                <div class=\"item-after vip\">¥{{data[0].discount}}</div>\r\n            </div>\r\n        </li>\r\n        <li>\r\n            <a href=\"#\" data-open-in=\"picker\" class=\"item-link ajax smart-select\">\r\n                <select name=\"store\">\r\n                    {{#each store}}\r\n                    <option value=\"{{id}}\" {{#if \"@index==0\"}}selected=\"selected\" {{/if}}>{{name}}</option>\r\n                    {{/each}}\r\n                </select>\r\n                <div class=\"item-content\">\r\n                    <div class=\"item-inner\">\r\n                        <div class=\"item-title\">常去门店\r\n                            <br><small>您已选择常去门店，我们将提供更精确的课程服务。</small></div>\r\n                        <div class=\"item-after\">{{store[0].name}}</div>\r\n                    </div>\r\n                </div>\r\n            </a>\r\n        </li>\r\n        <li>\r\n            <label class=\"label-radio item-content\">\r\n                <input type=\"radio\" value=\"\" checked=\"checked\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">微信支付</div>\r\n                </div>\r\n            </label>\r\n    </ul>\r\n</div>\r\n<!-- 提示 -->\r\n<!-- <div class=\"content-block-title\">温馨提示：</div>\r\n<div class=\"content-block\">\r\n    <p>1、预订成功后，在开始前6小时内取消预订的，将不予退款。</p>\r\n    <p>2、如预定的课程为会员独享类课程，则每用户每次仅限购买1人次，且课程不可重复购买。</p>\r\n    <p>3、进店密码将在课程开始前30分钟前生效，您可通过查看“我的预约”的课程门票、或檬运动公众号模板消息获取进店密码。</p>\r\n</div>\r\n -->\r\n";

/***/ }),
/* 10 */
/***/ (function(module, exports) {

	module.exports = "{{#js_compare \"!this.vip\"}}\r\n<div class=\"nomemaber\">\r\n    <p><span class=\"member-icon\"></span></p>\r\n    <p style=\"text-align: center;\">开通会员，享海量优惠！</p>\r\n    <div class=\"row title\">\r\n        <div class=\"col-33\"></div>\r\n        <div class=\"col-33\">会员</div>\r\n        <div class=\"col-33\">普通用户</div>\r\n    </div>\r\n    <div class=\"row-content\">\r\n        {{#each membership}}\r\n            <div class=\"row \">\r\n                <div class=\"col-33\">{{ship}}</div>\r\n                <div class=\"col-33\">{{vip}}</div>\r\n                <div class=\"col-33\">{{default}}</div>\r\n            </div>\r\n        {{/each}}\r\n    </div>\r\n</div>\r\n\r\n<div class=\"button-row\">\r\n    <a href=\"pages/member-open.html\" class=\"ajax button button-big button-fill\">立即开通会员</a>\r\n</div>\r\n{{else}}\r\n<div class=\"ismember\">\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n            <li>\r\n                <div class=\"item-content\">\r\n                    <div class=\"item-media\">\r\n                    \t<span class=\"headimg\" style=\"background-image: url('{{data.headimg}}');\"></span>\r\n                    </div>\r\n                    <div class=\"item-inner\">\r\n                        <div class=\"item-title-row\">\r\n                            <div class=\"item-title\">您好！会员：{{data.name}}</div>\r\n                            <div class=\"item-after\"></div>\r\n                        </div>\r\n                        <div class=\"item-text\">会员有效期至：{{data.menddate}}</div>\r\n                    </div>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n    <div class=\"content-block-title\">会员特权</div>\r\n    <div class=\"row-content\">\r\n        <div class=\"row \">\r\n            {{#each membership}}\r\n                <div class=\"col-50\">{{vip}}</div>\r\n            {{/each}}\r\n            <div class=\"col-50\">更多特权\r\n                <br>敬请期待</div>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div class=\"button-row\">\r\n    <a href=\"pages/member-open.html\" class=\"ajax button button-big button-fill\">续费</a>\r\n</div>\r\n{{/js_compare}}\r\n";

/***/ }),
/* 11 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"page-content\">\r\n    <div class=\"swiper-container\">\r\n        <div class=\"swiper-wrapper\">\r\n            {{#each data.images}}\r\n            <div class=\"swiper-slide\">\r\n                <img src=\"{{this}}\" width=\"100%\">\r\n            </div>\r\n            {{/each}}\r\n        </div>\r\n        <div class=\"swiper-pagination\"></div>\r\n    </div>\r\n    <!-- 基本信息 -->\r\n    <div class=\"content-block-title\" style=\"margin-top: 0\">基本信息</div>\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n            <li>\r\n                <a href=\"pages/coach.html?id={{data.coach}}\" class=\"item-link ajax item-content coach\" data-id=\"{{data.coach}}\">\r\n                    <div class=\"item-media\">\r\n                        <span class=\"coachbg\" style=\"background-image: url({{data.coachHeadimg}});\"></span>\r\n                    </div>\r\n                    <div class=\"item-inner\">\r\n                        <div class=\"item-title-row\">\r\n                            <div class=\"item-title\">{{data.coachName}}</div>\r\n                        </div>\r\n                        <div class=\"item-text\">{{data.coachCertificate}}</div>\r\n                        <div class=\"item-subtitle\">\r\n                            {{#each data.coachTag}}\r\n                            <span class=\"tip\">{{this}}</span> {{/each}}\r\n                        </div>\r\n                    </div>\r\n                </a>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">费用： ¥{{data.total}} (Move会员 ¥{{data.vip}})</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">时间： {{data.startDate}}~{{data.endDate}}</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">地址： {{data.address}}</div>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n    <!-- 课程简介 -->\r\n    <div class=\"content-block-title\">课程简介</div>\r\n    <div class=\"content-block \">\r\n        {{data.desc}}\r\n    </div>\r\n    <div class=\"content-block-title\">适合人群</div>\r\n    <div class=\"content-block\">\r\n        {{data.tip}}\r\n    </div>\r\n    <div class=\"content-block-title\">课程属性</div>\r\n    <div class=\"content-block\">\r\n        {{#each data.note}}\r\n        <span class=\"tip\">{{this}}</span> {{/each}}\r\n    </div>\r\n    <div class=\"content-block-title\">Move营流程</div>\r\n    <div class=\"content-block\">\r\n        <div class=\"timeline\">\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">1预约付费成功</div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    2获得入场密码\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    3输入密码进场\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    4现场签到上课\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n</div>\r\n<div class=\"toolbar order\">\r\n    <div class=\"toolbar-inner\">\r\n        <a  href=\"pages/order.html?id={{data.id}}&type=move\" class=\"item-link ajax \" >\r\n            立即预约<br><span>开通会员更划算</span>\r\n        </a>\r\n    </div>\r\n</div>\r\n";

/***/ }),
/* 12 */
/***/ (function(module, exports) {

	module.exports = "{{#if data.length>0}} {{#each data}}\r\n<li>\r\n    <a href=\"#\" class=\" item-content ajax\">\r\n        <!-- <div class=\"item-media\"><img src=\"{{images}}\" width=\"80\"></div> -->\r\n        <div class=\"item-inner\">\r\n            <div class=\"item-title-row\">\r\n                <div class=\"item-title\">\r\n                    {{name}}\r\n                </div>\r\n                <div class=\"item-after\">¥{{price}}</div>\r\n            </div>\r\n            <div class=\"item-text\">\r\n                <span>状态:\r\n\t\t            \t\t{{#js_compare \"this.state==0\"}}未支付{{/js_compare}}\r\n\t\t            \t\t{{#js_compare \"this.state==1\"}}已支付{{/js_compare}}\r\n\t\t            \t</span>\r\n            </div>\r\n            <div class=\"item-text\">\r\n                <span>人数:{{nop}}</span>\r\n            </div>\r\n            {{#if selftime}}\r\n            <div class=\"item-text\">\r\n                <span>预约时间:{{selftime}}</span>\r\n            </div>\r\n            {{/if}}\r\n            {{#if psw}}\r\n            <div class=\"item-text\">\r\n                <span>入场密码:{{psw}}</span>\r\n            </div>\r\n            {{/if}}\r\n        </div>\r\n    </a>\r\n</li>\r\n{{/each}} {{else}}\r\n<div class=\"content-block nodata\">\r\n    暂无预约\r\n</div>\r\n{{/if}}\r\n";

/***/ }),
/* 13 */
/***/ (function(module, exports) {

	module.exports = "<li class=\"item-content\">\r\n    <div class=\"item-inner\">\r\n        <div class=\"item-title\">订购状态：</div>\r\n        <div class=\"item-after\">\r\n            {{#js_compare \"this.data.state==0\"}}\r\n                未完成\r\n            {{else}}\r\n                完成\r\n            {{/js_compare}}\r\n        </div>\r\n    </div>\r\n</li>\r\n{{#js_compare \"this.type!='course'\"}}\r\n<li class=\"item-content\">\r\n    <div class=\"item-inner\">\r\n        <div class=\"item-title\">预约时间：</div>\r\n        <div class=\"item-after\">{{data.datetime}}</div>\r\n    </div>\r\n</li>\r\n{{else}}\r\n<li class=\"item-content\">\r\n    <div class=\"item-inner\">\r\n        <div class=\"item-title\">时间：</div>\r\n        <div class=\"item-after\">请联系教练预约上课时间</div>\r\n    </div>\r\n</li>\r\n<li class=\"item-content\">\r\n    <div class=\"item-inner\">\r\n        <div class=\"item-title\">教练手机：</div>\r\n        <div class=\"item-after\">{{data.phone}}</div>\r\n    </div>\r\n</li>\r\n{{/js_compare}}\r\n<li class=\"item-content\">\r\n    <div class=\"item-inner\">\r\n        <div class=\"item-title\">订单号：</div>\r\n        <div class=\"item-after\">{{data.out_trade_no}}</div>\r\n    </div>\r\n</li>\r\n{{#if data.psw}}\r\n<li class=\"item-content\">\r\n    <div class=\"item-inner\">\r\n        <div class=\"item-title\">入场密码：</div>\r\n        <div class=\"item-after\">{{data.psw}}</div>\r\n    </div>\r\n</li>\r\n{{/if}}\r\n";

/***/ }),
/* 14 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"list-block\">\r\n    <ul>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">支付项目:</div>\r\n                <div class=\"item-after\">\r\n                    {{#js_compare \"this.type=='store'\"}}\r\n                        {{data.name}} (自助健身)\r\n                        {{else}}\r\n                        {{data.name}}\r\n                    {{/js_compare}}\r\n                    \r\n                </div>\r\n            </div>\r\n        </li>\r\n        {{#js_compare \"this.type!='store'\"}}\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">时间:</div>\r\n                <div class=\"item-after\">\r\n                    {{#js_compare \"this.type=='course'\"}}与教练沟通确认{{/js_compare}}\r\n                    {{#js_compare \"this.type=='team'\"}}\r\n                        {{data.startDate}} ~ {{data.endDate}}\r\n                    {{/js_compare}}\r\n                    {{#js_compare \"this.type=='move'\"}}\r\n                        {{data.startDate}} ~ {{data.endDate}}\r\n                    {{/js_compare}}\r\n                </div>\r\n            </div>\r\n        </li>\r\n        {{/js_compare}}\r\n        {{#js_compare \"this.type=='store'\"}}\r\n        <li class=\"item-content\">\r\n            \r\n            <div class=\"item-inner\">\r\n            <div class=\"item-title label\">时间:</div>\r\n            <div class=\"item-input\" style=\"background-color: #fff;width: auto;text-align: right;\">\r\n                <input type=\"text\" placeholder=\"\" name=\"time\" id=\"time\" readonly=\"\" style=\"text-align: right;\">\r\n            </div>\r\n        </div>\r\n       \r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">时长:</div>\r\n                <div class=\"item-after\">\r\n                    60分钟\r\n                </div>\r\n            </div>\r\n        </li>\r\n        {{/js_compare}}\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">门店:</div>\r\n                <div class=\"item-after\" style=\"max-height: none;white-space: inherit;width: 50%;justify-content: flex-end;\">{{data.address}}</div>\r\n            </div>\r\n        </li>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">{{#js_compare \"this.type=='course'\"}}节数{{else}}人数{{/js_compare}}:</div>\r\n                <div class=\"item-after\">\r\n                    <span class=\"sub\" data-price=\"{{data.total}}\"  data-vip=\"{{data.vip}}\">-</span>\r\n                    <div class=\"item-input\">\r\n                        <input type=\"number\" disabled=\"disabled\" min=\"{{#js_compare \"this.data.count\"}}{{data.count}}{{else}}1{{/js_compare}}\" value=\"{{#js_compare \"this.data.count\"}}{{data.count}}{{else}}1{{/js_compare}}\" name=\"count\">\r\n                    </div>\r\n                    <span class=\"add\" data-price=\"{{data.total}}\"  data-vip=\"{{data.vip}}\">+</span>\r\n                </div>\r\n            </div>\r\n        </li>\r\n    </ul>\r\n</div>\r\n<div class=\"list-block\">\r\n    <ul>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">单价:</div>\r\n                <div class=\"item-after\" {{#js_compare \"this.isVip\"}}style=\"text-decoration:line-through;\"{{/js_compare}}>¥ {{data.total}}</div>\r\n            </div>\r\n        </li>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">会员单价:</div>\r\n                <div class=\"item-after\" {{#js_compare \"this.isVip\"}}style=\"color:#ffd103;\"{{else}}style=\"color:#ffd103;text-decoration:line-through;\"{{/js_compare}}>¥ {{data.vip}}</div>\r\n            </div>\r\n        </li>\r\n        <li class=\"item-content\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">实付金额:</div>\r\n                <div class=\"item-after total\" >\r\n                    {{#js_compare \"this.isVip\"}}\r\n                        ¥\r\n                        {{#js_compare \"this.data.count\"}}{{js \"return this.data.vip*this.data.count\"}}{{else}}{{data.vip}}{{/js_compare}}\r\n                    {{else}}\r\n                        ¥\r\n                        {{#js_compare \"this.data.count\"}}{{js \"return this.data.total*this.data.count\"}}{{else}}{{data.total}}{{/js_compare}}\r\n\r\n                    {{/js_compare}}\r\n                </div>\r\n            </div>\r\n        </li>\r\n        <label class=\"label-radio item-content\">\r\n            <input type=\"radio\" value=\"\" checked=\"checked\">\r\n            <div class=\"item-inner\">\r\n                <div class=\"item-title\">微信支付</div>\r\n            </div>\r\n        </label>\r\n    </ul>\r\n</div>\r\n<!-- 提示 -->\r\n<div class=\"content-block-title\">温馨提示：</div>\r\n<div class=\"content-block\">\r\n    <p>1、预订成功后，在开始前6小时内取消预订的，将不予退款。</p>\r\n    <p>2、如预定的课程为会员独享类课程，则每用户每次仅限购买1人次，且课程不可重复购买。</p>\r\n    <p>3、进店密码将在课程开始前30分钟前生效，您可通过查看“我的预约”的课程门票。</p>\r\n</div>\r\n";

/***/ }),
/* 15 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"page-content\">\r\n    <div class=\"swiper-container swiper-init\" data-pagination=\".swiper-pagination\">\r\n        <div class=\"swiper-wrapper\">\r\n            {{#each data.images}}\r\n            <div class=\"swiper-slide\">\r\n                <img src=\"{{this}}\" width=\"100%\">\r\n            </div>\r\n            {{/each}}\r\n        </div>\r\n        <div class=\"swiper-pagination\"></div>\r\n    </div>\r\n    <!-- 基本信息 -->\r\n    <div class=\"content-block-title\" style=\"margin-top: 0\">场地介绍</div>\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-text desc\">{{data.desc}}</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">详细地址：{{data.address}}</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">营业时间：{{data.datetime}}</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">客服电话：{{data.tel}}</div>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n    <div class=\"content-block-title\">Move店私教教练</div>\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n            {{#each coach}}\r\n                <li >\r\n                    <a href=\"pages/coach.html?id={{id}}\" class=\"item-link ajax item-content coach\" data-id=\"{{id}}\">\r\n                        <div class=\"item-media\">\r\n                            <span class=\"coachbg\" style=\"background-image: url({{headimg}});\"></span>\r\n\r\n                        </div>\r\n                        <div class=\"item-inner\">\r\n                            <div class=\"item-title-row\">\r\n                                <div class=\"item-title\">{{name}}</div>\r\n                            </div>\r\n                            <div class=\"item-text\">{{desc}}</div>\r\n                            <div class=\"item-subtitle\">\r\n                                {{#each tag}}\r\n                                    <span class=\"tip\">{{this}}</span>\r\n                                {{/each}}\r\n                            </div>\r\n                        </div>\r\n                    </a>\r\n                </li>\r\n            {{/each}}\r\n            \r\n        </ul>\r\n    </div>\r\n    <div class=\"content-block-title\">自助健身流程</div>\r\n    <div class=\"content-block\">\r\n        <div class=\"timeline\">\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">1预约付费成功</div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    2获得入场密码\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    3输入密码进场\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    4现场签到上课\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"content-block-title\">注意事项</div>\r\n    <div class=\"content-block\">\r\n        {{data.note}}\r\n    </div>\r\n</div>\r\n<div class=\"toolbar order\">\r\n    <div class=\"toolbar-inner\">\r\n        <a  href=\"pages/order.html?id={{data.id}}&type=store\" class=\"item-link ajax \" >\r\n            立即预约<br><span>开通会员更划算</span>\r\n        </a>\r\n    </div>\r\n</div>\r\n";

/***/ }),
/* 16 */
/***/ (function(module, exports) {

	module.exports = "{{#each data}}\r\n<li data-id=\"{{id}}\" data-type=\"course\">\r\n    <a class=\"item-content ajax\" href=\"pages/course.html?id={{id}}\">\r\n        <div class=\"item-media\">\r\n            <span class=\"coachbg\" style=\"background-image: url({{coachHeadimg}});\"></span>\r\n            \r\n        </div>\r\n        <div class=\"item-inner\">\r\n            <div class=\"item-title-row\">\r\n                <div class=\"item-title\">{{name}}</div>\r\n                <div class=\"item-after\">报名</div>\r\n            </div>\r\n            <div class=\"item-text\">{{desc}}\r\n            </div>\r\n            <div class=\"item-subtitle\">{{count}}节起卖 | ¥{{total}}/课时 <span>会员价 ¥{{vip}}</span></div>\r\n        </div>\r\n    </a>\r\n</li>\r\n{{/each}}\r\n";

/***/ }),
/* 17 */
/***/ (function(module, exports) {

	module.exports = "{{#each data}}\r\n\t<div class=\"swiper-slide\">\r\n\t   <a href=\"{{urllink}}\" style=\"font-size: 0\">\r\n\t   \t<span class=\"bg\" style=\"background-image: url('{{url}}');\"></span>\r\n\t   </a>\r\n\t</div>\r\n{{/each}}\r\n";

/***/ }),
/* 18 */
/***/ (function(module, exports) {

	module.exports = "{{#each data}}\r\n<div class=\"card card-header-pic\">\r\n    <a href=\"pages/move.html?id={{id}}\" class=\"ajax\" style=\"display: block;\">\r\n        <div style=\"background-image:url({{images[0]}});background-size: contain;\" valign=\"bottom\" class=\"card-header color-white no-border\"><div class=\"text\">{{name}}</div></div>\r\n    </a>\r\n    <div class=\"card-content\">\r\n        <a href=\"pages/move.html?id={{id}}\" class=\"ajax\" style=\"display: block;\">\r\n            <div class=\"card-content-inner\">\r\n                {{desc}}\r\n            </div>\r\n        </a>\r\n    </div>\r\n    <div class=\"card-footer\"><a href=\"#\" class=\"link\"><span class=\"price\">¥{{total}}</span> 会员价 ¥{{vip}}</a><a href=\"pages/move.html?id={{id}}\" class=\"link ajax report\">报名</a></div>\r\n</div>\r\n{{/each}}\r\n";

/***/ }),
/* 19 */
/***/ (function(module, exports) {

	module.exports = "{{#each data}}\r\n\t{{#if content.news_item}}\r\n\t\t{{#each content.news_item}}\r\n\t\t\t<li>\r\n\t\t\t    <a href=\"{{url}}\" class=\"item-content\">\r\n\t\t\t        <!-- <div class=\"item-media\"><img src=\"{{thumb_url}}&tp=webp&wxfrom=5&wx_lazy=1\" width=\"80px\"></div> -->\r\n\t\t\t        <div class=\"item-inner\">\r\n\t\t\t            <div class=\"item-title-row\">\r\n\t\t\t                <div class=\"item-title\">{{title}}</div>\r\n\t\t\t            </div>\r\n\t\t\t            <div class=\"item-text\">{{digest}}</div>\r\n\t\t\t        </div>\r\n\t\t\t    </a>\r\n\t\t\t</li>\r\n\t\t{{/each}}\r\n\t\t\r\n\t{{/if}}\r\n{{/each}}\r\n";

/***/ }),
/* 20 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = "<div class=\"person\">\r\n    <p class=\"headerimg\">\r\n        <img src=\"{{data.headimg}}\">\r\n        <span class=\"nickname\">{{data.name}}</span>\r\n    </p>\r\n    <div class=\"btn-row row\">\r\n        <a href=\"pages/my-order.html\" class=\"col-50 ajax\">\r\n            <img src=\"" + __webpack_require__(25) + "\">\r\n            <p>我的预约</p>\r\n        </a>\r\n        <a href=\"pages/my-member.html\" class=\"col-50 ajax\">\r\n            <img src=\"" + __webpack_require__(26) + "\">\r\n            <p>会员卡</p>\r\n        </a>\r\n    </div>\r\n</div>\r\n<div class=\"list-block\" style=\"margin: 10px 0\">\r\n    <ul>\r\n        <li>\r\n            <div class=\" item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">训练记录</div>\r\n                    <div class=\"item-after\"></div>\r\n                </div>\r\n            </div>\r\n        </li>\r\n        <li>\r\n            <div class=\" item-content\">\r\n                <div class=\"item-inner numberrow\">\r\n                    <div class=\"numberrow-row\">\r\n                        <div class=\"time-row\">\r\n                            {{data.traincount}}\r\n                        </div>\r\n                        <div class=\"time-row\">\r\n                            累计训练/次\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"numberrow-row\">\r\n                        <div class=\"time-row\">\r\n                            {{data.traintime}}\r\n                        </div>\r\n                        <div class=\"time-row\">\r\n                            累计时长/分钟\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n        </li>\r\n    </ul>\r\n</div>\r\n<div class=\"list-block\">\r\n    <ul>\r\n        <!-- <li>\r\n            <a href=\"#\" class=\"item-link item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">优惠券</div>\r\n                    <div class=\"item-after\"></div>\r\n                </div>\r\n            </a>\r\n        </li> -->\r\n        <li>\r\n            <a href=\"pages/help.html\" class=\"item-link item-content ajax\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">帮助中心</div>\r\n                    <div class=\"item-after\"></div>\r\n                </div>\r\n            </a>\r\n        </li>\r\n        <li>\r\n            <a href=\"pages/about.html\" class=\"item-link item-content ajax\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">关于魔虎运动</div>\r\n                    <div class=\"item-after\"></div>\r\n                </div>\r\n            </a>\r\n        </li>\r\n        <li>\r\n            <a href=\"#\" class=\"item-link item-content ajax deleteCoach\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">清空缓存</div>\r\n                    <div class=\"item-after\"></div>\r\n                </div>\r\n            </a>\r\n        </li>\r\n    </ul>\r\n</div>\r\n";

/***/ }),
/* 21 */
/***/ (function(module, exports) {

	module.exports = "{{#each data}}\r\n<li data-id=\"{{id}}\">\r\n\t<a href=\"pages/store.html?id={{id}}\" class=\"ajax\">\r\n    <div class=\"card card-header-pic\">\r\n        <div style=\"background-image:url({{images[0]}});background-size: contain;\" valign=\"bottom\" class=\"card-header color-white no-border\"><div class=\"text\">{{name}}</div></div>\r\n        <div class=\"card-footer item-link\">\r\n            <div class=\"item-inner\">\r\n                {{address}}\r\n            </div>\r\n        </div>\r\n    </div>\r\n    </a>\r\n</li>\r\n{{/each}}\r\n";

/***/ }),
/* 22 */
/***/ (function(module, exports) {

	module.exports = " {{#each data}}\r\n<li data-id=\"{{id}}\">\r\n    <a class=\"item-content ajax\" href=\"pages/team.html?id={{id}}\">\r\n        <div class=\"item-media\">\r\n            <span class=\"bg\" style=\"background-image: url({{images[0]}})\"></span>\r\n        </div>\r\n        <div class=\"item-inner\">\r\n            <div class=\"item-title-row\">\r\n                <div class=\"item-title\">{{name}}</div>\r\n            </div>\r\n            <div class=\"item-subtitle\"><span>¥{{total}}</span><span class=\"vip\">VIP ¥{{vip}}</span></div>\r\n            <div class=\"item-text\">{{js \"return new Date(this.startDate.replace(/-/g,'/')).format('h:mm')\"}} ~ {{js \"return new Date(this.endDate.replace(/-/g,'/')).format('h:mm')\"}}</div>\r\n        </div>\r\n        <div class=\"item-inner coach-after\">\r\n                <i style=\"background-image: url({{coachHeadimg}})\"></i>\r\n            <span>预约</span>\r\n        </div>\r\n    </a>\r\n    <p>\r\n        {{#each note}}\r\n        <span>{{this}}</span> {{/each}}\r\n</li>\r\n{{/each}}\r\n";

/***/ }),
/* 23 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"tab-date list-block\">\r\n    <ul>\r\n        {{#each sevneData}}\r\n                <li class=\"item-content {{#if active}}active{{/if}}\" data-tiemstamp=\"{{tiemstamp}}\">\r\n                    <div class=\"item-inner\">\r\n                        <div class=\"item-title\">\r\n                            {{date}}\r\n                            <br> \r\n                            {{day}}\r\n                        </div>\r\n                    </div>\r\n                </li>\r\n        {{/each}}\r\n        \r\n    </ul>\r\n</div>\r\n<div class=\"tab-card course-card\">\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n        </ul>\r\n    </div>\r\n</div>\r\n";

/***/ }),
/* 24 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"page-content\">\r\n    <div class=\"swiper-container\">\r\n        <div class=\"swiper-wrapper\">\r\n            {{#each data.images}}\r\n            <div class=\"swiper-slide\">\r\n                <img src=\"{{this}}\" width=\"100%\">\r\n            </div>\r\n            {{/each}}\r\n        </div>\r\n        <div class=\"swiper-pagination\"></div>\r\n    </div>\r\n    <!-- 基本信息 -->\r\n    <div class=\"content-block-title\" style=\"margin-top: 0\">基本信息</div>\r\n    <div class=\"list-block media-list\">\r\n        <ul>\r\n            <li>\r\n                <a href=\"pages/coach.html?id={{data.coach}}\" class=\"item-link ajax item-content coach\" data-id=\"{{data.coach}}\">\r\n                    <div class=\"item-media\">\r\n                        <span class=\"coachbg\" style=\"background-image: url({{data.coachHeadimg}});\"></span>\r\n                    </div>\r\n                    <div class=\"item-inner\">\r\n                        <div class=\"item-title-row\">\r\n                            <div class=\"item-title\">{{data.coachName}}</div>\r\n                        </div>\r\n                        <div class=\"item-text\">{{data.coachCertificate}}</div>\r\n                        <div class=\"item-subtitle\">\r\n                            {{#each data.coachTag}}\r\n                            <span class=\"tip\">{{this}}</span> {{/each}}\r\n                        </div>\r\n                    </div>\r\n                </a>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">费用： ¥{{data.total}} (Move会员 ¥{{data.vip}})</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">时间： {{data.startDate}}~{{data.endDate}}</div>\r\n                </div>\r\n            </li>\r\n            <li class=\"item-content\">\r\n                <div class=\"item-inner\">\r\n                    <div class=\"item-title\">地址： {{data.address}}</div>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n    </div>\r\n    <!-- 课程简介 -->\r\n    <div class=\"content-block-title\">课程简介</div>\r\n    <div class=\"content-block \">\r\n        {{data.desc}}\r\n    </div>\r\n    <div class=\"content-block-title\">适合人群</div>\r\n    <div class=\"content-block\">\r\n        {{data.tip}}\r\n    </div>\r\n    <div class=\"content-block-title\">课程属性</div>\r\n    <div class=\"content-block\">\r\n        {{#each data.note}}\r\n        <span class=\"tip\">{{this}}</span> {{/each}}\r\n    </div>\r\n    <div class=\"content-block-title\">团体课程流程</div>\r\n    <div class=\"content-block\">\r\n        <div class=\"timeline\">\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">1预约付费成功</div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    2获得入场密码\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    3输入密码进场\r\n                </div>\r\n            </div>\r\n            <div class=\"timeline-item\">\r\n                <div class=\"timeline-item-divider\"></div>\r\n                <div class=\"timeline-item-content\">\r\n                    4现场签到上课\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n</div>\r\n<div class=\"toolbar order\">\r\n    <div class=\"toolbar-inner\">\r\n        <a  href=\"pages/order.html?id={{data.id}}&type=team\" class=\"item-link ajax \" >\r\n            立即预约<br><span>开通会员更划算</span>\r\n        </a>\r\n    </div>\r\n</div>\r\n";

/***/ }),
/* 25 */
/***/ (function(module, exports) {

	module.exports = "data:image/jpeg;base64,"

/***/ }),
/* 26 */
/***/ (function(module, exports) {

	module.exports = "data:image/jpeg;base64,"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		getData:function(){
			var that = this
			$.ajax({
	            url:window.server+'api/coach.php',
	            type:'post',
	            data:{
	                type:'querycoach',
	                id:data.query.id,
	            ...
	            success:function(result){
	                ...
	                result.data.tag=result.data.tag.split(',')
	                result.data.images = result.data.images.split(',')
	               
	                data.container.html(api.renderTpl(html,{
	                	data:result.data
	                }))
		...
		swiper:function(){
			var mySwiper = app.swiper(data.container.find('.swiper-container'), {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		init:function(page){
	        ...
	        if(window.localStorage["tokenCoach"]==undefined){
	            app.popup(login)
	        }else{
	            that.getData()
	        }
	    ...
	    login:function(){
	        ...
	        $.ajax({
	            url:window.server+'api/coach/login.php',
	            type:'post',
	            data:{
	                username:username,
	                password:password
	            ...
	            success:function(result){
	                var result = JSON.parse(result)
	                if(result.success){
	                    window.localStorage["tokenCoach"]=result.token
	                    app.closeModal()
	                    that.getData()
	                }else{
	                    app.alert('账号密码错误')
		...
		getData:function(){
			var that = this
			$.ajax({
	            url:window.server+'api/coach/coach.php',
	            type:'post',
	            data:{
	                token:window.localStorage['tokenCoach'],
	                type:'queryCourse',
	                page:data.page,
	            ...
	            success:function(result){
	                ...
	                for (var i = 0; i < result.data.length; i++) {
	                     result.data[i].images = result.data[i].images.split(',')[0]
	                }
	                data.container.find('.page-content').html(api.renderTpl(html,{
	                	data:result.data
	                }))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    change:function(target){
	        data.container.find('.tab-link').removeClass('active')
	        target.addClass('active')
	        data.state = target.data('type')
	        this.getData()
	    },
		getData:function(){
	        app.showIndicator()
			...
			$.ajax({
	            ...
	            success:function(result){
	                ...
	                data.container.find('.page-content .nodata').html('')
	                data.container.find('.page-content ul').html('')

	                if(result.data.length==0){
	                     data.container.find('.page-content .nodata').html('<span style="margin-top:100px;display:block">暂无订单</span>')
	                    return false
	                }
	                
	                data.container.find('.page-content ul').html(api.renderTpl(html,{
	                	data:result.data
	                }))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		getData:function(){
			var that = this
			$.ajax({
	            url:window.server+'api/course.php',
	            type:'post',
	            data:{
	                type:'querycourse',
	                id:data.query.id,
	            ...
	            success:function(result){
	                ...
	                result.data.note=result.data.note.split(',')
	                result.data.images = result.data.images.split(',')
	                
	                if(result.data.coachTag){
	                	result.data.coachTag = result.data.coachTag.split(',')
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tabHotHtml = __webpack_require__(17)
	var tabNewsHtml = __webpack_require__(19)
	var tabMoveHtml = __webpack_require__(18)
	var tabPersonHtml = __webpack_require__(20)
	var tabTeamHtml = __webpack_require__(23)
	var tabTeamliHtml = __webpack_require__(22)
	var tabCourseliHtml = __webpack_require__(16)
	var tabStoreliHtml = __webpack_require__(21)
	...
	module.exports = {
	    init: function(page) {
	        ...
	        api.bindEvents([{
	                ...
	                element: data.container,
	                selector: '.home .tabclass1 .tab-date li',
	                event: 'click',
	                handler: function() {
	                    that.getTeam($(this))
	                }
	                ...
	                handler: function() {
	                    ...
	                    that.oauth(function(){
	                        ...
	                        that.getData(data.container.find('.tab-link[data-tabdata="tab4"]'))
	                    })
	                    // window.location.reload()
	                    // that.oauth()
	                    // that.oauth()
	                    // window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa2d8e6a449be3831&redirect_uri=' + encodeURIComponent(window.location.href) + '&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect'
	    ...
	    tabChange: function() {
	        ...
	        // that.oauth(function(){})
	        if(data.query.tab){
	            switch(data.query.tab){
	                case 'team':
	                    app.showTab('#tab2')

	                    that.getData(data.container.find('.tab-link[data-tabdata="tabclass1"]'))
	                break
	                case 'course':
	                    app.showTab('#tab2')
	                    app.showTab('#tabclass2')
	                    that.getData(data.container.find('.tab-link[data-tabdata="tabclass2"]'))
	                break
	                case 'move':
	                    app.showTab('#tab2')
	                    app.showTab('#tabclass3')
	                    that.getData(data.container.find('.tab-link[data-tabdata="tabclass3"]'))
	                break
	                case 'self':
	                    app.showTab('#tab2')
	                    app.showTab('#tabclass4')
	                    that.getData(data.container.find('.tab-link[data-tabdata="tabclass4"]'))
	                break
	                case 'store':
	                    app.showTab('#tab3')
	                    that.getData(data.container.find('.tab-link[data-tabdata="tab3"]'))
	                    break
	                case 'user':
	                    app.showTab('#tab4')
	    ...
	    oauth: function(callback) {
	        ...
	        if(window.localStorage["user"]==undefined){
	            ...
	            if(!api.getQueryString('code')){
	                ...
	                $.ajax({
	                    url: window.server + 'api/wechat.php',
	                    type: 'post',
	                    data: {
	                        type: 'oauth',
	                        code: api.getQueryString('code'),
	                    },
	                    success: function(data) {
	                        // app.alert(data)
	                        console.log(data)
	                        ...
	                        if (data != 'false') {
	                            ...
	                            if (data.openid) {
	                                $.ajax({
	                                    url: window.server + 'api/user.php',
	                                    type: 'post',
	                                    data: {
	                                        type: 'add',
	                                        name: api.decToHex(data.nickname),
	                                        openid: data.openid,
	                                    ...
	                                    success: function(data) {
	                                        ...
	                                        $.ajax({
	                                            ...
	                                            data: {
	                                                type: 'query',
	                                                openid: JSON.parse(window.localStorage['user']).openid,
	                                            },
	                                            success: function(data) {
	                                                ...
	                                                $("#tab4").html(api.renderTpl(tabPersonHtml, {
	                                                    data: data.data
	                                                }))
	                            ...
	                            window.location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa2d8e6a449be3831&redirect_uri=' + encodeURIComponent(window.location.origin+window.location.pathname+window.location.hash) + '&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect'
	                        }
	                    }
	                })
	            }
	    ...
	    getHot: function() {
	        ...
	        var that = this
	        $.ajax({
	            url: window.server + 'api/hot.php',
	            type: 'post',
	            success: function(result) {
	                var result = JSON.parse(result)
	                if (result.data.length > 0) {
	                    data.container.find("#tab1 .swiper-container .swiper-wrapper").html(api.renderTpl(tabHotHtml, {
	                        data: result.data
	                    }))
	                    var swiper = app.swiper(data.container.find("#tab1 .swiper-container"), {
	    ...
	    getNew: function() {
	        ...
	        $.ajax({
	            ...
	            success: function(result) {
	                ...
	                data.container.find("#tab1 .media-list ul").removeClass('nodata')
	                if (result.item.length > 0) {
	                    data.container.find("#tab1 .media-list ul").html(api.renderTpl(tabNewsHtml, {
	                        data: result.item
	                    }))
	                } else {
	                    data.container.find("#tab1 .media-list ul").addClass('nodata')
	                    data.container.find("#tab1 .media-list ul").html('<div >暂无数据</div>')
	                }
	                app.hideIndicator()
	    ...
	    getTeam: function(target) {
	        if (target.hasClass('active')) {
	            return false
	        }
	        app.showIndicator()
	        data.container.find(".tabclass1 .tab-date li").removeClass('active')
	        target.addClass('active')
	        var date = new Date(target.data('tiemstamp').replace(/-/g, "/"))
	        var month = date.getMonth() + 1;
	        month = month < 10 ? '0' + month : month


	        $.ajax({
	            url: window.server + 'api/team.php',
	            type: 'post',
	            data: {
	                type: 'query',
	                page: 1,
	            ...
	            success: function(result) {
	                ...
	                var result = JSON.parse(result)
	                for (var i = 0; i < result.data.length; i++) {
	                    if (result.data[i].note) {
	                        result.data[i].note = result.data[i].note.split(',')
	                    }
	                    result.data[i].images = result.data[i].images.split(',')

	                }
	                data.container.find("#tabclass1 .course-card ul").removeClass('nodata')
	                if (result.data.length > 0) {
	                    data.container.find("#tabclass1 .course-card ul").html(api.renderTpl(tabTeamliHtml, {
	                        data: result.data
	                    }))
	                } else {
	                    data.container.find("#tabclass1 .course-card ul").addClass('nodata')
	                    data.container.find("#tabclass1 .course-card ul").html('<div >排课中。。。</div>')
	                }
	                app.hideIndicator()
	            }
	        })
	    ...
	    getData: function(target) {
	        ...
	        var that = this
	        if (target.data('tabData') == 'tab1') {

	            that.getHot()
	            that.getNew()
	        }
	        app.showIndicator()
	        if (target.data('tabData') == 'tab2' || target.data('tabData') == 'tabclass1') {
	            var myDate = new Date();
	            ...
	            $.ajax({
	                ...
	                success: function(result) {
	                    ...
	                    that.getSevenDate(function() {
	                        $("#tabclass1").html(api.renderTpl(tabTeamHtml, { sevneData: data.dateArray }))

	                    })
	                    $("#tabclass1 .course-card ul").removeClass('nodata')
	                    if (result.data.length > 0) {
	                        $("#tabclass1 .course-card ul").html(api.renderTpl(tabTeamliHtml, {
	                            data: result.data
	                        }))
	                    } else {
	                        $("#tabclass1 .course-card ul").addClass('nodata')
	                        $("#tabclass1 .course-card ul").html('<div >排课中。。。</div>')
	                    }
	                    app.hideIndicator()
	        ...
	        if (target.data('tabData') == 'tabclass2') {
	            ...
	            $.ajax({
	                ...
	                success: function(result) {
	                    var result = JSON.parse(result)
	                    console.log(result)
	                    $("#tabclass2 .course-card ul").removeClass('nodata')
	                    if (result.data.length > 0) {
	                        $("#tabclass2 .course-card ul").html(api.renderTpl(tabCourseliHtml, {
	                            data: result.data,
	                        }))
	                    } else {
	                        $("#tabclass2 .course-card ul").addClass('nodata')
	                        $("#tabclass2 .course-card ul").html('<div >暂无数据</div>')
	                    }
	                    app.hideIndicator()
	        ...
	        if (target.data('tabData') == 'tabclass3') {

	            $.ajax({
	                url: window.server + 'api/move.php',
	                type: 'post',
	                data: {
	                    type: 'query',
	                    page: 1,
	                ...
	                success: function(result) {
	                    ...
	                    $("#tabclass3 .store-card ul").removeClass('nodata')
	                    if (result.data.length > 0) {
	                         $("#tabclass3 .store-card ul").html(api.renderTpl(tabMoveHtml, {
	                            data: result.data
	                        }))
	                    } else {
	                        $("#tabclass3 .store-card ul").addClass('nodata')
	                         $("#tabclass3 .store-card ul").html('<div >暂无数据。。。</div>')
	                    }
	                    app.hideIndicator()
	        ...
	        if (target.data('tabData') == 'tab3') {

	            $.ajax({
	                url: window.server + 'api/store.php',
	                type: 'post',
	                data: {
	                    type: 'query',
	                    page: 1,
	                ...
	                success: function(result) {
	                    var result = JSON.parse(result)
	                    console.log(result)
	                    $("#tab3 .store-card ul").removeClass('nodata')
	                    if (result.data.length > 0) {
	                        for (var i = 0; i < result.data.length; i++) {

	                            result.data[i].images = result.data[i].images.split(',')
	                        }
	                        $("#tab3 .store-card ul").html(api.renderTpl(tabStoreliHtml, {
	                            data: result.data,
	                        }))
	                    } else {
	                        $("#tab3 .store-card ul").addClass('nodata')
	                        $("#tab3 .store-card ul").html('<div >暂无数据</div>')
	                    }
	                    app.hideIndicator()
	        ...
	        if (target.data('tabData') == 'tabclass4') {
	            ...
	            $.ajax({
	                ...
	                success: function(result) {
	                    var result = JSON.parse(result)
	                    console.log(result)
	                    $("#tabclass4 .store-card ul").removeClass('nodata')
	                    if (result.data.length > 0) {
	                        for (var i = 0; i < result.data.length; i++) {

	                            result.data[i].images = result.data[i].images.split(',')
	                        }
	                        $("#tabclass4 .store-card ul").html(api.renderTpl(tabStoreliHtml, {
	                            data: result.data,
	                        }))
	                    } else {
	                        $("#tabclass4 .store-card ul").addClass('nodata')
	                        $("#tabclass4 .store-card ul").html('<div >暂无数据</div>')
	                    }
	                    app.hideIndicator()
	    ...
	    getSevenDate: function(callback) {
	        ...
	        for (var i = 0; i < 7; i++) {
	            ...
	            var month = (myDate.getMonth() + 1) < 11 ? '0' + (myDate.getMonth() + 1) : (myDate.getMonth() + 1)

	            dateTemp = month + "." + myDate.getDate();

	            data.dateArray.push({
	                date: dateTemp,
	                active: i == 0 ? true : false,
	                day: day[myDate.getDay()],
	                tiemstamp: myDate.getFullYear() + '-' + (myDate.getMonth() + 1) + '-' + myDate.getDate() + ' 23:59'
	            });
			 ...
			 $.ajax({
	            ...
	            success:function(result){
	                ...
	                for (var i = 0; i < membership.length; i++) {
	                	membership[i].ship=membership[i].ship.replace(/\r\n/g,"<br>");
	                	membership[i].index=i+1
	                }

	                window.user=result.data

	                
	                var vip = new Date(window.user.menddate) - new Date() > 0 ? true : false;

					data.container.find('.page-content').html(api.renderTpl(html,{data:result.data,vip:vip,membership:membership}))
	            }
	        })
		}
	}
	...
	module.exports = {
	    init: function(page) {
	        ...
	        that.getUserInfo(function(){
	            data.userInfo = window.user
	            that.getData()
	        })
	        
	        api.bindEvents([{
	                element: data.container,
	                selector: '.pay-after .price span',
	                event: 'click',
	                handler: function() {
	                    that.price($(this))
	                }
	    ...
	    price: function(target) {
	        data.container.find('.price span').removeClass('active');
	        target.addClass('active')

	        data.container.find('.count').text(target.data('count'))
	        data.container.find('.date').text('起始日期：' + target.data('start') + '~' + target.data('end'))
	        if (target.data('discount')) {

	            data.container.find('.discount .vip').text('¥' + target.data('discount'))
	            data.container.find('.discount').show()
	        } else {
	            data.container.find('.discount').hide()
	        }
	    },
	    order: function() {

	        if ((new Date()-data.lock)<3000) {
	            return false
	        }
	        data.lock = new Date()
	        var price = data.container.find('.price .active').data('id')
	        var store = data.container.find('select[name="store"]').val()

	        $.ajax({
	            url: 'http://movetiger.cn/pay/example/jsapi.php',
	            // url: window.server+'api/mymembercard.php',
	            type: 'post',
	            data: {
	                type: 'member',
	                    ...
	                    WeixinJSBridge.invoke(
	                        ...
	                        function(result) {
	                            ...
	                            if (result.err_msg == 'get_brand_wcpay_request:ok') {
	                                app.alert('恭喜您订购成功!', function() { homeF7View.router.back() })
	                            }
	                        }
	                    );
	                } else {
	    ...
	    getData: function() {
	        ...
	        app.showIndicator()
	        $.ajax({
	            url: window.server + 'api/price.php',
	            type: 'post',
	            data: {
	                type: 'query',
	                openid: JSON.parse(window.localStorage['user']).openid,
	            ...
	            success: function(result) {
	                ...
	                var myDate = new Date()
	                for (var i = 0; i < result.data.length; i++) {
	                    result.data[i].start = new Date().format("yyyy-MM-dd")
	                    myDate.setDate(myDate.getDate() + parseInt(result.data[i].month) * 30)
	                    result.data[i].end = myDate.format("yyyy-MM-dd")

	                    if(window.user.memberstate=='1'){
	                        result.data[i].start = new Date(window.user.mstartdate.replace(/-/g,'/')).format("yyyy-MM-dd")
	                        var temp =  new Date(window.user.menddate.replace(/-/g,'/'))
	                        temp.setDate(temp.getDate() + parseInt(result.data[i].month) * 30)
	                        result.data[i].end =temp.format("yyyy-MM-dd")
	                    }
	                   
	                    result.data[i].count = result.data[i].count / 100
	                    if (result.data[i].discount) {
	                        result.data[i].discount = result.data[i].discount / 100
	                    }
	                }
	                $.ajax({
	                    url: window.server + 'api/store.php',
	                    ...
	                    success: function(resultstore) {
	                        var resultstore = JSON.parse(resultstore)
	...
	module.exports = {
	    ...
	    getData:function(target){
	    	...
	    	if(target){
	    		...
	    		var type = data.container.find('.tab-link.active').data('type')
	    	}
	        data.container.find('.media-list ul').html('')
	    	$.ajax({
	    		url:window.server+'api/order.php',
	    		data:{
	    			type:type,
	    			openid: JSON.parse(window.localStorage["user"]).openid
	    		},
	    		...
	    		success:function(result){
	    			...
	    			if(result.success){
	    				...
	    				data.container.find('.media-list ul').html(api.renderTpl(html,{data:result.data,type:type}))	
	    			}
	    		}
	    	})
	    }
	        ...
	        switch (data.query.type) {
	            case 'course':
	                $.ajax({
	                    ...
	                    type: 'post',
	                    data: {
	                        type: 'querycourseOrder',
	                        id: data.query.out_trade_no,
	                    },
	                    success: function(result) {
	                        var result = JSON.parse(result)

	                        data.container.find('.page-content ul').html(api.renderTpl(html, { data: result.data, type: data.query.type }))
	                        app.hideIndicator()
	                    }
	                })
	                break
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    init: function(page) {
	        ...
	        data.lock = new Date()
	        that.getUserInfo(function(){
	            data.isVip = new Date(window.user.menddate) - new Date() > 0 ? true : false
	            that.getData()
	        })
	        api.bindEvents([{
	                element: data.container,
	                ...
	                event: 'click',
	                handler: function() {
	                    if (data.query.type == 'store') {
	                        app.alert('只能选择一人')
	                        return false;
	                    }
	                    var number = parseFloat(data.container.find('input[name="count"]').val()) - 1;
	                    if (number == 0) {
	                        return false
	                    }
	                    if (number < parseInt(data.container.find('input[name="count"]').attr('min'))) {
	                        app.alert('起购数量'+parseInt(data.container.find('input[name="count"]').attr('min')))
	                        return false
	                    }
	                    if (new Date(window.user.menddate) - new Date() > 0) {
	                        var total = parseFloat($(this).data('vip')) * number

	                    } else {
	                        var total = parseFloat($(this).data('price')) * number

	                    }

	                    data.container.find('.total').text('¥' + total.toFixed(2))

	                    data.container.find('input[name="count"]').val(number)
	                }
	            }, {
	                element: data.container,
	                selector: '.add',
	            ...
	            case 'course':
	                $.ajax({
	                    ...
	                    success: function(result) {
	                        ...
	                        data.container.find('.page-content').html(api.renderTpl(html, { data: result.data, type: data.query.type, isVip: data.isVip }))
	    ...
	    order: function() {
	        ...
	        if ((new Date() - data.lock) < 2000) {
	            return false
	        }
	        data.lock = new Date()
	        $.ajax({
	            url: 'http://movetiger.cn/pay/example/order.php',
	            type: 'post',
	            data: {
	                type: data.query.type,
	                id: data.query.id,
	                nop: data.container.find('input[name="count"]').val(),
	                openid: JSON.parse(window.localStorage["user"]).openid, 
	                selftime: data.query.type == 'store' ? data.pickerDependent.value.join(' ')+':00:00' : ''
	            },
	            success: function(result) {
	                ...
	                if (result.count==0 && result.count!=undefined) {
	                    homeF7View.router.load({
	                        url: 'pages/order-success.html?type=' + data.query.type + '&out_trade_no=' + result.order.out_trade_no
	                    })
	                    return false;
	                }
	    ...
	    timedisplayValues:function(time){
	        var arr = [];
	    ...
	    date: function() {
	        var that = this
	        $.ajax({
	            url: window.server + 'api/self.php',
	            type: 'post',
	            data: {
	                id: data.query.id,
	                openid: JSON.parse(window.localStorage["user"]).openid,
	            ...
	            success: function(result) {
	                // console.log(result)
	                var result = JSON.parse(result).data.day
	               
	                var today = new Date(result[0].day.replace(/-/g,'/'));

	                var tomall = new Date(result[1].day.replace(/-/g,'/'));
	                


	                data.pickerDependent = app.picker({
	                    input: data.container.find("#time"),
	                    toolbarTemplate: '',
	                    value: [today.format('yyyy-MM-d'), result[0].time[0]],
	                    displayValues: [today.format('MM 月 d 号'), result[1].time[0]+'点'],
	                    ...
	                    cols: [{
	                        textAlign: 'left',
	                        values: [today.format('yyyy-MM-d'), tomall.format('yyyy-MM-d')],
	                        displayValues: [today.format('MM 月 d 号'), tomall.format('MM 月 d号')],
	                        onChange:function(picker,target,other){
	                            if(target==today.format('yyyy-MM-d')){
	                                picker.cols[1].replaceValues(that.timeValue(result[0].time),that.timedisplayValues(result[0].time));

	                            }
	                            if(target==tomall.format('yyyy-MM-d')){
	                                picker.cols[1].replaceValues(that.timeValue(result[1].time),that.timedisplayValues(result[1].time));
	                                                                
	                            }
	                        }
	                    }, {
	                        values:that.timeValue(result[1].time),
	                        displayValues: that.timedisplayValues(result[1].time)
	                    }, ]
	                });
	        ...
	        // var today = new Date();
	        // var time = data.container.find("#time").val()==''?new Date():new Date(data.container.find("#time").val());
	        // var startDate = app.picker({
	        //     input: data.container.find("#time"),
	        //     toolbar: false,
	        //     rotateEffect: true,

	        //     value: [time.getFullYear(), time.getMonth()+1, time.getDate(),  time.getHours(), (time.getMinutes() < 10 ? '0' + time.getMinutes() : time.getMinutes())],
		...
		getData:function(){
			...
			$.ajax({
	            ...
	            success:function(result){
	                ...
	                result.data.images = result.data.images.split(',')
	                result.data.note= result.data.note.replace(/\r?\n/g,"<br />")
	               	for (var i = 0; i < result.coach.length; i++) {
	               		if(result.coach[i].tag){
	               			result.coach[i].tag=result.coach[i].tag.split(",")
	               		}
	               	}
