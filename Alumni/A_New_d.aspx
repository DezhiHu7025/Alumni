<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_New_d.aspx.cs" Inherits="Alumni.A_New_d" %>
...
<head runat="server">
    ...
    <title>在读/转出证明申请</title>
    <link href="css/app.css" rel="stylesheet" />
</head>
<body class="framework7-root">
    <form id="form1" runat="server"></form>
    <div class="views  toolbar-through" style="display:inline;position:relative;">
        <div id="homeView" class="view view-main" data-page="course">
            <div class="pages ">
                <div class="page course page-on-center" data-page="course">
                    <div class="page-content">
                        <div style="background: #fff;"><img src="img/1123.jpg" width="100%"></div>
                    ...
                    <div class="toolbar tabbar">
                        <div class="toolbar-inner">
                            <a href="A_New.aspx" class="tab-link ajax">返回<br />
                            </a>
                            |
                            <a href="A_info_z.aspx?id=<%=id%>" class="tab-link ajax ">立即填单<br />
                            </a>
                        </div>
                    </div>
                </div>
