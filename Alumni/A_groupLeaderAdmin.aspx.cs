...
namespace Alumni
{
    public partial class A_groupLeaderAdmin : System.Web.UI.Page
    {
        ...
        private void myControlBind()
        {
            ...
            string sqlstr = "select * from [db_forminf].[dbo].[OldStudentOnlin] where shopForm_id='S0000001'and form_id in('P0000002','P0000003') order by id";
        ...
        private void myTableBind(bool DoExport)
        {
            ...
            string sqlstr1 = "SELECT a.*,b.form_id as Bproduct_id  FROM [db_forminf].[dbo].[OldStudent_Onlin_List] a left join [db_forminf].[dbo].[OldStudentOnlin] b on a.form_name = b.form_name where b.form_id in('P0000002','P0000003') order by a.addtime desc ";
            ...
            foreach (DataRowView myRow1 in myView1)
            {
                if (i >= StartNum && i <= EndNum)
                {
                    ...
                    PlaceHolderList.Controls.Add(new LiteralControl("<td align=\"center\"><span style=\"color:#117ED0;\">" + form_name + "</span></td>"));
        ...
        private void myTableBind_upload(bool DoExport)
        {
            ...
            DataColumn dc4 = new DataColumn("邮箱/邮寄地址", Type.GetType("System.String"));
            DataColumn dc5 = new DataColumn("手机号", Type.GetType("System.String"));
            DataColumn dc6 = new DataColumn("提交时间", Type.GetType("System.String"));
