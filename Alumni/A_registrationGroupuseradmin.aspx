<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_registrationGroupuseradmin.aspx.cs" Inherits="Alumni.A_registrationGroupuseradmin" %>
        ...
        <ContentTemplate>
            ...
            <tr style="height:40px; background-color:#CC5599;width:100%;">
                <td colspan="19" style="text-align:center; ">
                    <span style="color:White; font-size:20px;">在读/转学证明单据后台数据</span>
                </td>
            </tr>
                ...
                <td align="center" style="color:Black; width:5%;"><span style="color:White;">证件类型</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">证件号码</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">护照英文名</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">户籍地</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">邮寄地址</span></td>
                <td align="center" style="color:Black; width:8%;"><span style="color:White;">邮箱地址</span></td>
